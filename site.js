(function () {
  ...
  try {
    ...
    // switch, for the same reason as above.
    ...
    // In-site page links, collected once: the nav, the brand marks, the
    ...
    Array.prototype.slice.call(document.querySelectorAll("a[href]")).forEach(function (a) {
      ...
      // "./privacy.html" both match; a fragment-only href ("#features") leaves
      // an empty path and is skipped.
